  ...
  <Grid item xs={12} sm={6} md={4}>
    ...
    >
      <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
        <Typography sx={{ fontWeight: 'bold', color: '#E0E1DD', fontSize: '1rem' }}>ה{event.TypeOfEvent} של</Typography>
        <Typography sx={{ fontWeight: 'bold', color: '#E0E1DD', fontSize: '1.5rem' }}>
      ...
      <CardContent sx={{ alignItems: 'center', textAlign: 'center', justifyContent: 'space-between', background: 'rgba(255, 255, 255, 0.1)', height: '30px' }}>
        <Typography sx={{ fontWeight: 'bold', color: '#E0E1DD', fontSize: '1rem' }}>לפרטים לחץ כאן</Typography>
      </CardContent>
