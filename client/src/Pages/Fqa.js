...
const faqs = [
  {
    ...
    answer: 'האתר שלנו מציע העברת מתנות לאירועים בצורה פשוטה ונקייה. בנוסף, הוא מציע שירותי סיכום לקבלת מתנות או הוספת אירוע חדש בהתאם לרמת ההרשמה במערכת (אורח, משתמש רשום, בעל אירוע, אדמין).'
  },
  {
    id: 2,
    question: 'מהי שיטת התשלום המועדפת שלנו?',
    answer: 'האתר מציע כרגע אפשרות אחת לתשלום דרך PayPal בדולרים. בגרסה הבאה יהיו עוד אפשרויות של סוגי מטבעות ו-API נוספים.'
  },
  {
    id: 3,
    question: 'כיצד אני פותח חשבון?',
    answer: 'בעמוד הראשון של האתר ישנן 4 אפשרויות הרשמה: הראשונה למי שכבר רשום, השנייה להרשמה חדשה, השלישית לאורחים, והרביעית לבעלי אירועים.'
  },
  {
    id: 4,
    question: 'כיצד אני עוקב אחר כמה אנשים שלחו מתנות?',
    answer: 'לאורח אין אפשרות כזו. משתמש רשום יכול לראות בדף ההיסטוריה (נמצא בסרגל הניווט למעלה) סיכום של כל המתנות, באיזה אירוע, תאריכים, סכומים ואיזו ברכה נשלחה.'
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer: 'לאחר כניסה לאתר כבעל אירוע, בדף הוספת אירועים יש כפתור להוספת אירוע חדש ולמילוי כל הפרטים הנדרשים.'
  },
  {
    id: 7,
  ...
  },
  {
    ...
    answer: 'כרגע, לצערנו, אין אפליקציה, אבל אנחנו עובדים על גרסה אפליקטיבית שתהיה זמינה בקרוב.'
  },
  {
    id: 10,
  ...
  },
  {
    ...
    answer: 'כפתור בסרגל הניווט למעלה בצד ימין. כרגע האתר זמין רק באנגלית, תהיה גם עברית בגרסה הבאה.'
  },
  {
    id: 14,
    question: 'כיצד אני מאפס את הסיסמה שלי?',
    answer: "ניתן לאפס את הסיסמה על ידי לחיצה על 'שכחתי סיסמה' בדף ההתחברות ומעקב אחר ההוראות."
  },
  {
    id: 15,
  ...
  },
  {
    ...
    answer: 'ניתן לפנות לתמיכה שלנו דרך דף יצירת הקשר או לשלוח מייל לכתובת support@example.com.'
  },
  {
    id: 17,
  ...
  },
  {
    ...
    answer: 'ניתן לשלוח מתנות, להוסיף אירועים (לבעלי אירוע), ולצפות בהיסטוריית המתנות (למשתמשים רשומים). כרגע לא ניתן לבטל מתנות או לערוך אירועים לאחר הוספתם.'
  },
  {
    id: 19,
    question: "מהן הגבלות הגיל לשימוש ב-'Easy Gift'?",
    answer: 'משתמשים חייבים להיות בני 18 ומעלה, או להשתמש בהשגחת הורה או אפוטרופוס.'
  },
  {
    id: 20,
    question: 'האם אני יכול לשנות את הברכות שלי?',
    answer: 'כרגע לא ניתן לערוך ברכות לאחר שליחתן. ייתכן שתהיה אפשרות כזו בגרסה הבאה.'
  },
  {
    id: 21,
    question: 'כרטיס האשראי שלי נדחה, מה עליי לעשות?',
    answer: 'אנא בדוק שהפרטים שהזנת נכונים, ושיש לך מספיק יתרה. אם הבעיה נמשכת, פנה לחברת האשראי שלך או השתמש באמצעי תשלום אחר.'
  },
  // שאלות נוספות:
  {
    id: 22,
    question: "האם המידע האישי שלי מאובטח ב-'Easy Gift'?",
    answer: 'כן, אנו משתמשים בפרוטוקולי אבטחה מתקדמים כדי להבטיח שהמידע האישי שלך מוגן.'
  },
  {
    id: 23,
    question: 'כיצד אני פונה לתמיכת הלקוחות?',
    answer: "ניתן לפנות אלינו דרך דף 'צור קשר' באתר או לשלוח מייל לכתובת support@example.com."
  },
  {
    id: 24,
    question: "האם אני יכול להשתמש ב-'Easy Gift' מהמכשיר הנייד שלי?",
    answer: 'כן, האתר מותאם למכשירים ניידים, אך החוויה הטובה ביותר היא דרך מחשב או לפטופ.'
  },
  {
    id: 25,
    question: 'איזה מטבעות מתקבלים?',
    answer: 'כרגע, התשלומים מתבצעים בדולרים דרך PayPal. בעתיד נרחיב את התמיכה במטבעות נוספים.'
  },
  {
    id: 26,
    question: 'כיצד אני מזמין אורחים לאירוע שלי?',
    answer: 'לאחר יצירת האירוע, תוכל לשלוח קישורים לאורחים כדי שיצטרפו וישלחו מתנות.'
  },
  {
    id: 27,
  ...
  },
  {
    ...
    answer: 'השימוש באתר הוא חינמי. עם זאת, עשויות להיות עמלות תשלום מצד PayPal או חברות האשראי.'
  },
  {
    id: 31,
    question: 'האם אני יכול להתאים אישית את המראה של דף האירוע שלי?',
    answer: 'כרגע, האפשרויות להתאמה אישית מוגבלות. אנו עובדים על הוספת אפשרויות נוספות בעתיד.'
  },
  {
    id: 32,
    question: 'האם יש הגבלה לסכום שאני יכול לשלוח כמתנה?',
    answer: 'לא, אין הגבלה לסכום, אך ייתכן ויהיו הגבלות מצד חברת האשראי או PayPal.'
  },
  {
    id: 33,
